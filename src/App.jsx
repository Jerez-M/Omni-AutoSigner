...
import PdfEditor from "./components/PdfEditor"; // New PDF Editor Component
    ...
    useEffect(() => {
        switch (location.pathname) {
            ...
            case '/view-documents':
                setTitle("Documents");
                break;
            case '/pdf-editor': // New route for PDF Editor
                setTitle("PDF Editor");
                break;
            default:
                setTitle("Overview");
        ...
        <div className='flex h-screen bg-gray-900 text-gray-100'>
            ...
            <div className={`flex-1 ${shouldShowSidebarAndHeader ? 'pt-20' : ''} overflow-auto scrollable hide-scrollbar ${isSidebarOpen && shouldShowSidebarAndHeader ? 'ml-0' : 'ml-0'}`}>
                ...
                <Routes>
                    ...
                    <Route path='/pdf-editor' element={<PdfEditor />} /> {/* New PDF Editor Route */}
