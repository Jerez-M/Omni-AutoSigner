...
const ViewDocument = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const organisation_id = 1; // Example organisation ID
            try {
    ...
    return (
        <motion.div
            className='bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 mb-8 mx-40 mt-10'
